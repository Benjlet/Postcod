    ...
    public class PostcodesIOServiceTests
    {
        ...
        public async Task PostcodesIO_ValidResponse_ShouldParse()
        {
            ...
            _httpClientWrapper.Setup(x => x.GetAsync(It.IsAny<string>())).ReturnsAsync(
                $"{{ \"status\":200,\"result\":{{ \"postcode\":\"{postcode}\",\"quality\":1,\"eastings\":391879,\"northings\":173567,\"country\":\"England\",\"nhs_ha\":\"South West\",\"longitude\":{longitude},\"latitude\":{latitude},\"european_electoral_region\":\"South West\",\"primary_care_trust\":\"Wiltshire\",\"region\":\"South West\",\"lsoa\":\"Wiltshire 011B\",\"msoa\":\"Wiltshire 011\",\"incode\":\"1HH\",\"outcode\":\"SN15\",\"parliamentary_constituency\":\"Chippenham\",\"admin_district\":\"Wiltshire\",\"parish\":\"Chippenham\",\"admin_county\":null,\"date_of_introduction\":\"198001\",\"admin_ward\":\"Chippenham Hardens & Central\",\"ced\":null,\"ccg\":\"NHS Bath and North East Somerset, Swindon and Wiltshire\",\"nuts\":\"Wiltshire\",\"pfa\":\"Wiltshire\",\"codes\":{{ \"admin_district\":\"E06000054\",\"admin_county\":\"E99999999\",\"admin_ward\":\"E05013419\",\"parish\":\"E04013038\",\"parliamentary_constituency\":\"E14000635\",\"ccg\":\"E38000231\",\"ccg_id\":\"92G\",\"ced\":\"E99999999\",\"nuts\":\"TLK15\",\"lsoa\":\"E01031912\",\"msoa\":\"E02006654\",\"lau2\":\"E06000054\",\"pfa\":\"E23000038\"}} }} }}");

            var searchResult = await _sut.Search(postcode);

            Assert.Multiple(() =>
            {
                Assert.That(searchResult.Postcode.ToString(), Is.EqualTo(postcode));
